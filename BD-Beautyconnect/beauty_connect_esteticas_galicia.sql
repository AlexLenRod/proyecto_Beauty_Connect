...
--
-- Table structure for table `esteticas_galicia`
--

DROP TABLE IF EXISTS `esteticas_galicia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `esteticas_galicia` (
  `ID` int NOT NULL,
