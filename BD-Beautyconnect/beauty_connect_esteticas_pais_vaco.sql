...
--
-- Table structure for table `esteticas_pais_vaco`
--

DROP TABLE IF EXISTS `esteticas_pais_vaco`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `esteticas_pais_vaco` (
  `ID` int NOT NULL,
...
-- Dump completed on 2022-05-04 23:58:46
